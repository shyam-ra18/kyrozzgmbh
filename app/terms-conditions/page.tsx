      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="bg-white border border-slate-200/60 rounded-3xl p-8 sm:p-12 shadow-[0_4px_24px_rgba(0,0,0,0.02)]">
          ...
          <div className="space-y-6 text-slate-600 text-sm sm:text-base leading-relaxed font-medium">
            ...
            <h2 className="text-lg font-bold text-slate-800 uppercase tracking-wider mt-8 mb-3">7. Retention of title</h2>
            <p>
            ...
            <h2 className="text-lg font-bold text-slate-800 uppercase tracking-wider mt-8 mb-3">8. Transport damage</h2>
            <p>
            ...
            <h2 className="text-lg font-bold text-slate-800 uppercase tracking-wider mt-8 mb-3">9. Warranty and warranties</h2>
            <p>
            ...
            <ul className="list-disc pl-5 space-y-1">
              ...
              <li>within the framework of a guarantee promise, insofar as agreed</li>
              <li>insofar as the scope of application of the Product Liability Act is opened up.</li>
            </ul>

            <h2 className="text-lg font-bold text-slate-800 uppercase tracking-wider mt-8 mb-3">10. Liability</h2>
            <p>
            ...
            <h2 className="text-lg font-bold text-slate-800 uppercase tracking-wider mt-8 mb-3">11. Dispute resolution</h2>
            <p>
              The European Commission provides an online dispute resolution (OS) platform, which you can find here <a href="https://ec.europa.eu/consumers/odr/" className="text-blue-600 hover:underline" target="_blank" rel="noopener noreferrer">https://ec.europa.eu/consumers/odr/</a>. We are neither obliged nor willing to participate in a dispute resolution procedure before a consumer arbitration body.
            </p>

            <h2 className="text-lg font-bold text-slate-800 uppercase tracking-wider mt-8 mb-3">12. License</h2>
            <p>
            ...
            <h2 className="text-lg font-bold text-slate-800 uppercase tracking-wider mt-8 mb-3">13. Industrial property rights / Copyrights / Rights to documents, data</h2>
            <p>
            ...
            <h2 className="text-lg font-bold text-slate-800 uppercase tracking-wider mt-8 mb-3">14. Final provisions</h2>
            <p>

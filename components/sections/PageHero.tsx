...
export function PageHero({
  ...
  return (
    <section className="relative w-full overflow-hidden bg-slate-950 pt-24 lg:pt-20 lg:pt-24 pb-12 lg:pb-16 border-b border-slate-900">
      {/* Background elements */}
      ...
      <div className="relative z-10 section-container">
        ...
        >
          ...
          <h1 className="text-[clamp(2rem,1.5rem+2.5vw,3.25rem)] font-bold text-white mb-6 leading-tight tracking-tight">
            {title}
          </h1>

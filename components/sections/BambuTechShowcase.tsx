...
export function BambuTechShowcase() {
  ...
  return (
    <div className="bg-white">
      ...
      <section className="py-12 lg:py-12 lg:py-16">
      ...
      <section className="py-12 lg:py-12 lg:py-16 bg-slate-50/50 border-t border-b border-slate-100">
      ...
      <section className="pb-12 lg:pb-16">
        <div className="section-container">
          {/* 5-Step Process Grid */}
          <div className="relative mb-12 lg:mb-16 pt-16 max-w-6xl mx-auto">
      ...
      <section className="relative overflow-hidden pb-12 lg:pb-16 bg-white border-t border-slate-100">
        ...
        <div className="section-container relative z-10 flex flex-col lg:flex-row">
          <div className="w-full lg:w-1/2 py-12 lg:py-12 lg:py-12 lg:py-16 lg:pr-12">
